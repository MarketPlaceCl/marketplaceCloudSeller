...
class Items{   
	...
	function create(){
		...
		$stmt = $this->conn->prepare("
			INSERT INTO ".$this->itemsTable."(`name`, `description`, `price`, `category_id`,`brand_id`, `created`)
			VALUES(?,?,?,?,?,?)");
		...
		$stmt->bind_param("ssiiis", $this->name, $this->description, $this->price, $this->category_id,$this->brand_id, $this->created);
